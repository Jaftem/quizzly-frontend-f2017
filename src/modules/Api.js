...
var Api = module.exports = {
  server: new Route(window.location.port == '4000' ? 'http://localhost:1337' : 'http://34.211.174.198:1337'),
  db: new Route(window.location.port == '4000' ? 'http://localhost:1337' : 'http://34.211.174.198:1337'),
  otherDb: new Route(chooseUrl("redPay")),
  baseUrl:  window.location.port == '4000' ? 'http://localhost:1337' : 'http://34.211.174.198:1337',
}
